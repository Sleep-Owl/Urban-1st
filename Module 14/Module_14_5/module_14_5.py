...
butt11 = KeyboardButton('Регистрация')
...
async def get_buying_list(message):
    ...
    for product in all_products:
        with open(
                f'D:/Disc D/Program Files/PyCharm Community Edition 2024.1.4/My projects/Urban-1st/Module 14/Module_14_3/{i}.png',
                'rb') as img:
            await message.answer_photo(img, f'Название: {product[0]} | Описание: {product[1]} | Цена: {product[2]}')
            i += 1
